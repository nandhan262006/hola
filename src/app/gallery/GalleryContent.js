...
const galleryItems = [
  { type: 'image', src: '/images/bride-hero.png', label: 'Bridal Makeup' },
  ...
  { type: 'placeholder', gradient: 'linear-gradient(160deg, #0a0a1a, #05050d)', icon: '💅', label: 'Manicure' },
  { type: 'placeholder', gradient: 'linear-gradient(160deg, #1a1510, #0d0a08)', icon: '🌿', label: 'Waxing' },
  { type: 'placeholder', gradient: 'linear-gradient(160deg, #15101a, #0a080d)', icon: '🔮', label: 'Threading' },
