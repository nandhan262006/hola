        ...
        <div className="hero-text-wrap" style={{
          ...
          <div style={{maxWidth:'520px'}}>
            ...
            <div className="hero-cta" style={{display:'flex',flexWrap:'wrap',gap:'16px'}}>
              <a href="https://wa.me/919490939727?text=Hi!%20I%20would%20like%20to%20book%20an%20appointment%20at%20Hola%20Beauty%20Parlour." target="_blank" rel="noopener noreferrer" className="btn-crimson">
                {/* Calendar icon */}
        ...
        <div style={{maxWidth:'1100px',margin:'0 auto'}}>
          ...
          <div className="reviews-track-wrap" style={{
            ...
            <div className="reviews-track" style={{
              display:'flex', gap:'20px', animation:'scrollReviews 15s linear infinite',
            }}>
              {[
